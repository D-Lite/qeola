    ...
    return (
        <div className="flex w-[100vw] h-full pb-72 overflow-hidden justify-between items-center">
            ...
            <div className=''>
                ...
                <div className=''>
                    <p onClick={() => setSelectedTab(2)} className={`cursor-pointer ${selectedTab === 2 ? 'bg-clip-text text-transparent bg-gradient-to-r from-pink-500 hover:to-violet-500' : 'text-[#B2ADD1]'} text-[40px] font-[900] leading-[90px] w-[700px] text-left hover:bg-clip-text hover:text-transparent hover:bg-gradient-to-r hover:from-pink-500 hover:to-violet-500`}>
                        Enhance visibility
                    </p>
