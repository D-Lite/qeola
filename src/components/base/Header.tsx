            ...
            <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <Popover.Group className="hidden lg:flex lg:gap-x-8 items-center">
                    ...
                    <Popover className="relative">
                        ...
                        >
                            <Popover.Panel className=" absolute bg-white w-screen top-full z-10 mt-8 inset-x-0  overflow-hidden flex shadow-lg ring-1 ring-gray-900/5">
                                <div className="block visible w-[740px] pointer-events-auto leading-[24px]">
                                    <p className="block text-[14px] font-[700] h-[21px] mt-[38px] pointer-events-auto text-left mb-[25px] ml-[16px]">PRODUCT</p>
                                    ...
                                    <ul className='box-border text-[#292d34] flex flex-wrap font-axiforma gap-[20px] text-left visible'>
                                        ...
                                        <li className="box-border text-[#292d34] h-[60px] pointer-events-auto w-full py-[12px] px-[18px] relative text-center list-item my-5">
                                            <a className="header-product-btn " href="/features">
                                                See All Features
                    ...
                    <Popover className="relative">
                        ...
                        <Transition
                            ...
                            leaveTo="opacity-0 translate-y-1"
                        >
                            <Popover.Panel className="absolute z-10 mt-3 w-screen max-w-screen-2xl -left-full overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5">
                                <div className="p-4">
                                    {products.map((item) => (
                                        <div
                                            key={item.name}
